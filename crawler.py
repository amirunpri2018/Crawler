...
parser.add_argument("--dir", type=str, default=os.path.join(fileDir, "images"), help="image directory")
parser.add_argument("--num", type=int, default=10, help="number of images")
parser.add_argument("--interval", type=int, default=10000, help="interval in milliseconds")
